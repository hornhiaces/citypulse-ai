...
serve(async (req) => {
  ...
  try {
    ...
    const systemPrompt = mode === "citizen"
      ? `You are City Pulse AI, a friendly civic transparency assistant for Montgomery, Alabama. You help citizens understand their city's conditions using real municipal data.
...
${context}`
      : `You are City Pulse AI, an executive intelligence briefing system for Montgomery, Alabama city leadership. You provide strategic operational analysis using real municipal datasets.
